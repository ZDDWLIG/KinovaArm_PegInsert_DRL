...
class gen3env(gym.Env):
    ...
    def __init__(self):
        ...
        self.hole_pose=[0.7,-0.2,0.3] #[1.,-0.2,0.3] 
        self.info=None
        self.fail_num=0
        self.step_num=0
        action_low=[-1.,-1.,-1.,-1.]
    ...
    def get_obs(self):
        ...
        peg_x,peg_y,peg_z=self.robot.get_link_pose('link_0')
    ...
    def compute_reward(self,action,obs):
        ...
        def reach_reward():
            ...
            grab_rew=min(action[3],1)*0.05
            # if left_finger_pose[2]<0.05:
                # reach_reward-=(0.05 - left_finger_pose[2]) / 0.05 * 0.05
    ...
    def step(self,action):
        ...
        self.step_num+=1
        done=bool(peg_hole_dis<0.005) or self.tot_steps == 70 or self.fail_num == 10     
        if done:
            self.step_num=0
            self.fail_num=0
